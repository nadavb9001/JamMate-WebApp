...
export const app = {
  ...
  setupPresetListeners() {
    ...
    document.getElementById('btnConfirmSave').onclick = () => {
      ...
      BLEService.send(Protocol.createSavePreset(bankIndex, slotIndex, this.getCurrentState()));
      modal.classList.remove('active');
      modal.style.display = '';
    };
  },
  ...
  selectEffect(idx) {
    ...
    View.showEffectControls(
      ...
      (b, en, f, g, q) => {
        ...
        this.currentEQPoints[b] = { freq: f, gain: g, q: q,
  ...
  sendConfigUpdate() {
    ...
    BLEService.send(Protocol.createConfigUpload());
